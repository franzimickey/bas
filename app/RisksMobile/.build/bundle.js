...
/***/ "./build.definitions/RisksMobile/Rules/AppUpdateFailure.js":
/*!*****************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/AppUpdateFailure.js ***!
  \*****************************************************************/
...
function AppUpdateFailure(clientAPI) {
  ...
  return clientAPI.getPageProxy().executeAction({
    "Name": "/RisksMobile/Actions/AppUpdateFailureMessage.action",
    "Properties": {
      "Duration": 0,
      "Message": message
    }
...
/***/ "./build.definitions/RisksMobile/Rules/AppUpdateSuccess.js":
/*!*****************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/AppUpdateSuccess.js ***!
  \*****************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function AppUpdateSuccess(clientAPI) {
  ...
  return sleep(500).then(function () {
    ...
    if (result.startsWith('Current version is already up to date')) {
      return clientAPI.getPageProxy().executeAction({
        "Name": "/RisksMobile/Actions/AppUpdateSuccessMessage.action",
        "Properties": {
...
function DeleteConfirmation(clientAPI) {
  return clientAPI.executeAction('/RisksMobile/Actions/DeleteConfirmation.action').then(result => {
    if (result.data) {
      return clientAPI.executeAction('/RisksMobile/Actions/Mitigations/Mitigations_DeleteEntity.action').then(success => Promise.resolve(success), failure => Promise.reject('Delete entity failed ' + failure));
    } else {
...
/***/ "./build.definitions/RisksMobile/Rules/OnWillUpdate.js":
/*!*************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/OnWillUpdate.js ***!
  \*************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function OnWillUpdate(clientAPI) {
  return clientAPI.executeAction('/RisksMobile/Actions/OnWillUpdate.action').then(result => {
    if (result.data) {
...
/***/ "./build.definitions/RisksMobile/Rules/ResetAppSettingsAndLogout.js":
/*!**************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Rules/ResetAppSettingsAndLogout.js ***!
  \**************************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function ResetAppSettingsAndLogout(context) {
  ...
  try {
    ...
    // Logout 
    return context.getPageProxy().executeAction('/RisksMobile/Actions/Logout.action');
  }
}
...
function DeleteConfirmation(clientAPI) {
  return clientAPI.executeAction('/RisksMobile/Actions/DeleteConfirmation.action').then(result => {
    if (result.data) {
      return clientAPI.executeAction('/RisksMobile/Actions/Risks/Risks_DeleteEntity.action').then(success => Promise.resolve(success), failure => Promise.reject('Delete entity failed ' + failure));
    } else {
      return Promise.reject('User Deferred');
    }
  });
...
// Imports
var ___CSS_LOADER_API_NO_SOURCEMAP_IMPORT___ = __webpack_require__(/*! ../../../../../extbin/local/openvscode-server/extensions/mdk-vsc-wing-23.11.0/node_modules/css-loader/dist/runtime/noSourceMaps.js */ "../../extbin/local/openvscode-server/extensions/mdk-vsc-wing-23.11.0/node_modules/css-loader/dist/runtime/noSourceMaps.js");
...
/***/ "../../extbin/local/openvscode-server/extensions/mdk-vsc-wing-23.11.0/node_modules/css-loader/dist/runtime/noSourceMaps.js":
/*!*********************************************************************************************************************************!*\
  !*** ../../extbin/local/openvscode-server/extensions/mdk-vsc-wing-23.11.0/node_modules/css-loader/dist/runtime/noSourceMaps.js ***!
  \*********************************************************************************************************************************/
/***/ ((module) => {
...
module.exports = {"_Name":"RisksMobile","Version":"/RisksMobile/Globals/AppDefinition_Version.global","MainPage":"/RisksMobile/Pages/Main.page","OnLaunch":["/RisksMobile/Actions/Service/InitializeOnline.action"],"OnWillUpdate":"/RisksMobile/Rules/OnWillUpdate.js","OnDidUpdate":"/RisksMobile/Actions/Service/InitializeOnline.action","Styles":"/RisksMobile/Styles/Styles.css","Localization":"/RisksMobile/i18n/i18n.properties","_SchemaVersion":"23.8","StyleSheets":{"Styles":{"css":"/RisksMobile/Styles/Styles.light.css","ios":"/RisksMobile/Styles/Styles.light.nss","android":"/RisksMobile/Styles/Styles.light.json"}},"SDKStyles":{"ios":"/RisksMobile/Styles/Styles.light.nss","android":"/RisksMobile/Styles/Styles.light.json"}}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/AppUpdate.action":
/*!****************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/AppUpdate.action ***!
  \****************************************************************/
/***/ ((module) => {

module.exports = {"_Type":"Action.Type.ApplicationUpdate","ActionResult":{"_Name":"AppUpdate"},"OnFailure":"/RisksMobile/Rules/AppUpdateFailure.js","OnSuccess":"/RisksMobile/Rules/AppUpdateSuccess.js"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/AppUpdateFailureMessage.action":
/*!******************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/AppUpdateFailureMessage.action ***!
  \******************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RisksMobile/Actions/AppUpdateProgressBanner.action":
/*!******************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/AppUpdateProgressBanner.action ***!
  \******************************************************************************/
/***/ ((module) => {

module.exports = {"Animated":true,"CompletionTimeout":3,"Message":"Checking for Updates...","OnSuccess":"/RisksMobile/Actions/AppUpdate.action","_Type":"Action.Type.ProgressBanner"}

/***/ }),

/***/ "./build.definitions/RisksMobile/Actions/AppUpdateSuccessMessage.action":
/*!******************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/AppUpdateSuccessMessage.action ***!
  \******************************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RisksMobile/Actions/Logout.action":
/*!*************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/Logout.action ***!
  \*************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RisksMobile/Actions/LogoutMessage.action":
/*!********************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/LogoutMessage.action ***!
  \********************************************************************/
/***/ ((module) => {

module.exports = {"CancelCaption":"No","Message":"This action will remove all data and return to the Welcome screen. Any local data will be lost. Are you sure you want to continue?","OKCaption":"Yes","OnOK":"/RisksMobile/Rules/ResetAppSettingsAndLogout.js","Title":"Logout","_Type":"Action.Type.Message"}
...
/***/ "./build.definitions/RisksMobile/Actions/OnWillUpdate.action":
/*!*******************************************************************!*\
  !*** ./build.definitions/RisksMobile/Actions/OnWillUpdate.action ***!
  \*******************************************************************/
/***/ ((module) => {
...
/***/ "./build.definitions/RisksMobile/Globals/AppDefinition_Version.global":
/*!****************************************************************************!*\
  !*** ./build.definitions/RisksMobile/Globals/AppDefinition_Version.global ***!
  \****************************************************************************/
/***/ ((module) => {
...
module.exports = {"DestinationName":"RiskManagementService","OfflineEnabled":false,"LanguageURLParam":"","OnlineOptions":{"ServiceOptions":{"fixMissingNullValues":true}},"PathSuffix":"","SourceType":"Cloud","ServiceUrl":""}
...
let risksmobile_actions_appupdate_action = __webpack_require__(/*! ./RisksMobile/Actions/AppUpdate.action */ "./build.definitions/RisksMobile/Actions/AppUpdate.action")
let risksmobile_actions_appupdatefailuremessage_action = __webpack_require__(/*! ./RisksMobile/Actions/AppUpdateFailureMessage.action */ "./build.definitions/RisksMobile/Actions/AppUpdateFailureMessage.action")
let risksmobile_actions_appupdateprogressbanner_action = __webpack_require__(/*! ./RisksMobile/Actions/AppUpdateProgressBanner.action */ "./build.definitions/RisksMobile/Actions/AppUpdateProgressBanner.action")
let risksmobile_actions_appupdatesuccessmessage_action = __webpack_require__(/*! ./RisksMobile/Actions/AppUpdateSuccessMessage.action */ "./build.definitions/RisksMobile/Actions/AppUpdateSuccessMessage.action")
...
let risksmobile_actions_logout_action = __webpack_require__(/*! ./RisksMobile/Actions/Logout.action */ "./build.definitions/RisksMobile/Actions/Logout.action")
let risksmobile_actions_logoutmessage_action = __webpack_require__(/*! ./RisksMobile/Actions/LogoutMessage.action */ "./build.definitions/RisksMobile/Actions/LogoutMessage.action")
...
let risksmobile_actions_onwillupdate_action = __webpack_require__(/*! ./RisksMobile/Actions/OnWillUpdate.action */ "./build.definitions/RisksMobile/Actions/OnWillUpdate.action")
...
let risksmobile_globals_appdefinition_version_global = __webpack_require__(/*! ./RisksMobile/Globals/AppDefinition_Version.global */ "./build.definitions/RisksMobile/Globals/AppDefinition_Version.global")
...
let risksmobile_rules_appupdatefailure_js = __webpack_require__(/*! ./RisksMobile/Rules/AppUpdateFailure.js */ "./build.definitions/RisksMobile/Rules/AppUpdateFailure.js")
let risksmobile_rules_appupdatesuccess_js = __webpack_require__(/*! ./RisksMobile/Rules/AppUpdateSuccess.js */ "./build.definitions/RisksMobile/Rules/AppUpdateSuccess.js")
...
let risksmobile_rules_onwillupdate_js = __webpack_require__(/*! ./RisksMobile/Rules/OnWillUpdate.js */ "./build.definitions/RisksMobile/Rules/OnWillUpdate.js")
let risksmobile_rules_resetappsettingsandlogout_js = __webpack_require__(/*! ./RisksMobile/Rules/ResetAppSettingsAndLogout.js */ "./build.definitions/RisksMobile/Rules/ResetAppSettingsAndLogout.js")
...
module.exports = {
	...
	risksmobile_actions_appupdate_action : risksmobile_actions_appupdate_action,
	risksmobile_actions_appupdatefailuremessage_action : risksmobile_actions_appupdatefailuremessage_action,
	risksmobile_actions_appupdateprogressbanner_action : risksmobile_actions_appupdateprogressbanner_action,
	risksmobile_actions_appupdatesuccessmessage_action : risksmobile_actions_appupdatesuccessmessage_action,
	...
	risksmobile_actions_logout_action : risksmobile_actions_logout_action,
	risksmobile_actions_logoutmessage_action : risksmobile_actions_logoutmessage_action,
	...
	risksmobile_actions_onwillupdate_action : risksmobile_actions_onwillupdate_action,
	...
	risksmobile_globals_appdefinition_version_global : risksmobile_globals_appdefinition_version_global,
	...
	risksmobile_rules_appupdatefailure_js : risksmobile_rules_appupdatefailure_js,
	risksmobile_rules_appupdatesuccess_js : risksmobile_rules_appupdatesuccess_js,
	...
	risksmobile_rules_onwillupdate_js : risksmobile_rules_onwillupdate_js,
	risksmobile_rules_resetappsettingsandlogout_js : risksmobile_rules_resetappsettingsandlogout_js,
